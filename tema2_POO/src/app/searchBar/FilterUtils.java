...
public final class FilterUtils {
     ...
     * Filter by age list
     */
    public static List<LibraryEntry> filterByAge(final List<LibraryEntry> entries,
                                                       final String age) {
        return filter(entries, entry -> entry.matchesAge(age));
    }

    /**
     * Filter by city list
     */
    public static List<LibraryEntry> filterByCity(final List<LibraryEntry> entries,
                                                 final String city) {
        return filter(entries, entry -> entry.matchesCity(city));
    }
